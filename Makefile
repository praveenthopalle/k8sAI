# Copyright 2023 k8sAI AI. All rights reserved.
...
#
ROOT_PACKAGE=github.com/k8sAI-ai/k8sAI
...
IMG ?= ghcr.io/k8sAI-ai/k8sAI:latest

BUILDFILE = "./main.go"
BUILDAPP = "$(OUTPUT_DIR)/k8sAI"
...
.PHONY: deploy
deploy: helm
	@echo "===========> Deploying k8sAI"
	$(HELM) install k8sAI charts/k8sAI -n k8sAI --create-namespace

## update: Update k8sAI
.PHONY: update
update: helm
	@echo "===========> Updating k8sAI"
	$(HELM) upgrade k8sAI charts/k8sAI -n k8sAI

## undeploy: Undeploy k8sAI
.PHONY: undeploy
undeploy: helm
	@echo "===========> Undeploying k8sAI"
	$(HELM) uninstall k8sAI -n k8sAI
...
#	@addlicense -y $(shell date +"%Y") -v -c "k8sAI AI." -f $(LICENSE_TEMPLATE) $(CODE_DIRS)
