...
import (
	...
	"github.com/adrg/xdg"
	"github.com/k8sAI-ai/k8sAI/cmd/analyze"
	"github.com/k8sAI-ai/k8sAI/cmd/auth"
	"github.com/k8sAI-ai/k8sAI/cmd/cache"
	customanalyzer "github.com/k8sAI-ai/k8sAI/cmd/customAnalyzer"
	"github.com/k8sAI-ai/k8sAI/cmd/dump"
	"github.com/k8sAI-ai/k8sAI/cmd/filters"
	"github.com/k8sAI-ai/k8sAI/cmd/generate"
	"github.com/k8sAI-ai/k8sAI/cmd/integration"
	"github.com/k8sAI-ai/k8sAI/cmd/serve"
	"github.com/k8sAI-ai/k8sAI/pkg/util"
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", fmt.Sprintf("Default config file (%s/k8sAI/k8sAI.yaml)", xdg.ConfigHome))
...
func initConfig() {
	if cfgFile != "" {
		...
		// the config will belocated under `~/.config/k8sAI/k8sAI.yaml` on linux
		configDir := filepath.Join(xdg.ConfigHome, "k8sAI")
...
func getConfigFilePath() string {
	return filepath.Join(xdg.ConfigHome, "k8sAI", "k8sAI.yaml")
}
...
func getLegacyConfigFilePath() (string, error) {
	...
	return filepath.Join(home, ".k8sAI.yaml"), nil
}
