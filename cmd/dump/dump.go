...
var DumpCmd = &cobra.Command{
	Use:   "dump",
	Short: "Creates a dumpfile for debugging issues with k8sAI",
	Long:  `The dump command will create a dump.*.json which will contain k8sAI non-sensitive configuration information.`,
