...
- An OpenAI API key
  ...
  * You can set the API key for k8sAI using `./k8sAI auth key`
- If you want to build the container image, you need to have a container engine (docker, podman, rancher, etc.) installed

## Getting Started

**Where should I start?**
- If you are new to the project, please check out the [good first issue](https://github.com/k8sAI-ai/k8sAI/labels/good%20first%20issue) label.
- If you are looking for something to work on, check out our [open issues](https://github.com/k8sAI-ai/k8sAI/issues).
...
* Join our [#k8sAI slack channel](https://join.slack.com/t/k8sAI/shared_invite/zt-1rwe5fpzq-VNtJK8DmYbbm~iWL1H34nw)
...
## Building
Building the binary is as simple as running `go build .` in the root of the repository. If you want to build the container image, you can run `docker build -t k8sAI -f container/Dockerfile .` in the root of the repository.

## Releasing
Releases of k8sAI are done using [Release Please](https://github.com/googleapis/release-please) and [GoReleaser](https://goreleaser.com/). The workflow looks like this:
